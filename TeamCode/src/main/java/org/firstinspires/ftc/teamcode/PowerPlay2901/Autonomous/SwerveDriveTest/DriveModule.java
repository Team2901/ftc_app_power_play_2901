...
public class DriveModule {
    ...
    //TODO: modify this variable to match drive gear ratio
    public final double TICKS_PER_WHEEL_REV = 537.7/2.0833; //ticks per WHEEL revolution

    public final double CM_WHEEL_DIAMETER = 7.2; //TODO: change to match wheel size
