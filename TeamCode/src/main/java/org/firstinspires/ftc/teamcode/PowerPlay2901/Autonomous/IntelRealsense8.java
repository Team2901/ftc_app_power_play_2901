...
@Autonomous(name="8 - Preload/Park", group="Iterative Opmode")
public class IntelRealsense8 extends OpMode {
       ...
       if(improvedGamepad.a.isInitialPress()) {
        ...
        if(robot.pipeLine.winner == -1){
            ...
            if(!isTurning && !isMoving && !isLifting) {
                ...
                liftEngage = true;
            }else if(positionX - averagedX > xTolerance && positionY - averagedY < yTolerance){
